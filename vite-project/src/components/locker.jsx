      ...
      <div style={{ flex: 1 }}>
        ...
        >
          <div style={{ display: "flex", gap: 4 }}>
            <button onClick={() => setViewYear((v) => v - 1)} style={calBtn}>
              «
            </button>
            <button
              onClick={() =>
          ...
          {hours.map((h) => (
            <div
              ...
              style={{
                ...
                background:
                  h === selectedHour ? "rgba(167,139,250,0.15)" : "transparent",
              }}
            >
          ...
          {mins.map((m) => (
            <div
              ...
              style={{
                ...
                background:
                  m === selectedMin ? "rgba(167,139,250,0.15)" : "transparent",
              }}
            >
        ...
        <div style={{ display: "flex", gap: 6, padding: "0 14px 18px" }}>
          <button
            ...
            style={{
              ...
              border:
                "1px solid " +
                (roleTab === "investor" ? "#2a3a4a" : "transparent"),
            }}
          >
            Investor
          </button>
        ...
        <div style={{ borderTop: "1px solid #181f2a", paddingTop: 16 }}>
          {SERVICE_ITEMS.map((item) => (
            <div
              ...
              onMouseEnter={(e) => {
                if (!item.active) e.currentTarget.style.color = "#c0ccd8";
              }}
              onMouseLeave={(e) => {
                if (!item.active) e.currentTarget.style.color = "#6b7a8d";
              }}
            >
      ...
      <div style={styles.main}>
        ...
        <div style={styles.topbar}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <span style={{ color: "#6b7a8d", fontSize: 11 }}>
              0xBBB6A7...6hn9
            </span>
          </div>
        </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <button
                ...
                style={{
                  ...
                  border: "1px solid #2a3a4a",
                  background:
                    activeTab === "editwithdraw" ? "#1a2030" : "transparent",
          ...
          {step === "address" && activeTab === "newlock" && (
            <div style={{ ...styles.card, maxWidth: 680 }}>
              ...
              {pairAddress.length > 5 && (
                <>
                  <div
                    style={{ fontSize: 12, color: "#8899aa", marginBottom: 10 }}
                  >
                    Pairs found
                  </div>
          ...
          {step === "liquidity" && (
            ...
            >
                  ...
                  {pctBtns.map((p) => (
                    <button
                      ...
                      style={{
                        ...
                        padding: "4px 12px",
                        fontSize: 12,
                        color: activePct === p ? "#a78bfa" : "#8899aa",
                        cursor: "pointer",
                        fontFamily: "inherit",
                      }}
                    >
              ...
              <div style={{ ...styles.card, position: "relative" }}>
                ...
                >
                  <div>
                    ...
                    <div
                      style={{ fontSize: 11, color: "#4a5568", marginTop: 3 }}
                    >
                      A few seconds ago
                    </div>
                  </div>
              ...
              <div style={styles.card}>
                ...
                <div
                  style={{ fontSize: 11, color: "#6b7a8d", marginBottom: 12 }}
                >
                  Allows the token developer locking the LP to declare a
                  different address
                </div>
                <div
                  style={{
                ...
                >
                  <input
                    ...
                    style={{
                      ...styles.inputBox,
                      fontSize: 12,
                      color: unlockerAddr ? "#c0ccd8" : "#6b7a8d",
                    }}
                  />
                </div>
                {unlockerAddr && (
                ...
                >
                  <input
                    ...
                    style={{
                      ...styles.inputBox,
                      fontSize: 12,
                      color: referralAddr ? "#c0ccd8" : "#6b7a8d",
                    }}
                  />
                </div>
              </div>
              ...
              >
                ...
                >
                  <div
                    style={{ fontSize: 12, color: "#8899aa", lineHeight: 1.6 }}
                  >
